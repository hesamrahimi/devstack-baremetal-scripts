...
node_id_atom=$( $NOVA_BIN_DIR/nova-bm-manage --config-dir=$BM_CONF  node create --host $HOST  --cpus 1 --memory_mb=4096 --local_gb=60 --pm_address="10.10.30.6" --pm_user=".1.3.6.1.4.1.21728.3.2.1.1.4.0,.1.3.6.1.4.1.21728.3.2.1.1.3.0" --pm_password="savi" --terminal_port=0 --prov_mac_address=08:00:27:38:98:88 --type=i686)
...
$NOVA_BIN_DIR/nova-bm-manage --config-dir=$BM_CONF  interface create --node_id=$node_id_atom --mac_address=08:00:27:C9:DC:7D --datapath_id=0x0 --port_no=0
